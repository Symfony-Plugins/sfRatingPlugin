...
sfConfig::set(
    sprintf('propel_behavior_sfPropelActAsRatableBehavior_%s_max_rating', 
            get_class($obj)), 5);
$t->is(sfRatingToolkit::getMaxRating($obj), 5, 'getMaxRating() retrieve correct value');
sfConfig::set(
    sprintf('propel_behavior_sfPropelActAsRatableBehavior_%s_max_rating', 
            get_class($obj)), 10);
$t->is(sfRatingToolkit::getMaxRating($obj), 10, 'getMaxRating() retrieve correct value, even when changed');

$max_rating = sfRatingToolkit::getMaxRating($obj);
